        ...
        render() {
            ...
            return (
                <Target
                    ...
                    additionalStyles={{
                        text: {},
                        frame: this.props.moveUp ? animationStyle : {}
                    }}
                />
            );
        }
...
const makeMoveWithSpring = Target => {
    return class extends Component {
        render() {
            const style = {
                translateY: this.props.moveUp
                    ? spring(-150, presets.wobbly)
                    : spring(0)
            };
...
export const makeTranslateUp = Target =>
    makeMoveUp(makeMoveWithTranslate(Target));
